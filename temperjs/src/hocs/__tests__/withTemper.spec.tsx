...
import { storeActions } from 'temperjs-store' // We will call `storeActions` methods directly to check the results of `useTraitsValue`
import withTemper from '../withTemper'

const TestComponent: React.FunctionComponent = function () {
